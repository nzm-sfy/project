...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        // Status of RequestStatus is set as LAB_TEST_COMPLETED of testRequestQueryService
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // Returns the doctor from the testRequestQueryService
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            // An object of TestRequest class that assigns the consultation using logged in user id
            TestRequest assignConsultation = testRequestUpdateService.assignForConsultation(id, doctor);

            // Returns the assignConsultation object
            return assignConsultation;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            // An object of TestRequest class that updates the consultation using logged in user id
            TestRequest updateForConsultation = testRequestUpdateService.updateConsultation(id, testResult, doctor);

            // Returns the updateForConsultation object
            return updateForConsultation;
