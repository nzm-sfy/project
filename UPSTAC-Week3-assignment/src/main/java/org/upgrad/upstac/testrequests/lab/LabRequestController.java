...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        //Return the requested test as status initiated
    ...
    public List<TestRequest> getForTester()  {
        ...
        // Returns the testRequestQueryService object using logged in user
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        try {
            ...
            // Assigns the test to the logged in user with id
            TestRequest assignTest = testRequestUpdateService.assignForLabTest(id, tester);

            // Returns the assignTest object
            return assignTest;
    ...
    public TestRequest updateLabTest(@PathVariable Long id,@RequestBody CreateLabResult createLabResult) {
        ...
        try {
            ...
            // Assigns updated test to the logged in user using the id
            TestRequest updateTest = testRequestUpdateService.updateLabTest(id, createLabResult, tester);

            // Returns the updateTest object
            return updateTest;
